...
from utils_ablation import load_GBP_data,muticlass_f1, accuracy, get_silhouette_score
...
parser.add_argument('--alias_name', type=str, default="bbknn", help='graph construction method.')
parser.add_argument('--result', type=str, default="result.out", help='save result.')
...
features,labels,idx_train,idx_val,idx_test, rename = load_GBP_data(args.data,args.alpha,args.rmax,args.rrz, origin_data=args.origin_data)
ori_labels=labels
...
with open(args.result, 'a+') as f:
   # f.write("\n")
    ...
    f.write("{}:{}\n".format(args.alias_name+"!"+args.data,acc2))
